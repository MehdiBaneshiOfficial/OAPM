...
---
*این یک ترجمه‌ی سریع از README روسیِ پروژه‌ی متن‌باز «Open AG Patcher» است. توجه داشته باشید این ابزار محدودیت‌های منطقه‌ای/eligibility گوگل را دور می‌زند که ممکن است با شرایط استفاده‌ی این سرویس‌ها در تضاد باشد؛ استفاده با مسئولیت خودتان است.*